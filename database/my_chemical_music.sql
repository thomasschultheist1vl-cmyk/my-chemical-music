...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2026 a las 03:03:05
...
INSERT INTO `compras_proveedores` (`id_compra`, `id_proveedor`, `fecha`, `total`) VALUES
(1, 1, '2026-09-12', 30000.00);
...
(1, 'Guitarra Stratocaster', 'Guitarra electrica color negro', 350000.00, 5, 1, 1, 1, 1),
...
INSERT INTO `servicios` (`id_servicio`, `id_cliente`, `instrumento`, `descripcion`, `fecha_ingreso`, `fecha_entrega`, `precio`, `id_estado_servicio`) VALUES
(1, 1, 'guitarra', 'calibracion', '2026-09-09', '2026-09-15', 9000.00, 2),
(2, 1, 'guitarra 2', 'calibrar 2da guitarra', '2026-08-22', '2026-09-12', 12900.00, 1);
...
INSERT INTO `ventas` (`id_venta`, `id_cliente`, `fecha`, `total`, `id_medio_pago`) VALUES
(1, 1, '2026-06-12', 350000.00, 2);
...
--
ALTER TABLE `estados_servicio`
  MODIFY `id_estado_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
